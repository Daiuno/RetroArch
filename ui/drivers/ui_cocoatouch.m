...
- (void)loadAmiibo:(NSString *_Nonnull)path {
    ...
    typedef bool (*retro_azahar_load_amiibo_t)(const char*);
    retro_azahar_load_amiibo_t load_amiibo =
        (retro_azahar_load_amiibo_t)dylib_proc(runloop_st->lib_handle, "retro_azahar_load_amiibo");
    if (load_amiibo) {
...
- (BOOL)isSearchingAmiibo {
    ...
    typedef bool (*retro_azahar_is_searching_amiibo_t)(void);
    retro_azahar_is_searching_amiibo_t is_searching =
        (retro_azahar_is_searching_amiibo_t)dylib_proc(runloop_st->lib_handle,
                                                       "retro_azahar_is_searching_amiibo");
    if (is_searching) {
